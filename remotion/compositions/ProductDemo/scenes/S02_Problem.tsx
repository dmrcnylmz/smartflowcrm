/**
 * S02 Problem — Pain Points (8s / 240 frames)
 *
 * Typewriter headline → 3 GlassCards slide in staggered → fade out
 */
...
const PROBLEMS = [
  {
    icon: '📵',
    title: 'Cevapsız Çağrılar',
    description: 'Müşterilerinizin %30\'u ilk aramada ulaşamıyor',
    stat: '%30',
  },
  {
    icon: '⏳',
    title: 'Uzun Bekleme Süreleri',
    description: 'Ortalama bekleme süresi 3 dakikayı aşıyor',
    stat: '3+ dk',
  },
  {
    icon: '💸',
    title: 'Yüksek Maliyet',
    description: 'Çağrı merkezi maliyetleri sürekli artıyor',
    stat: '↑ %40',
  },
];
...
export const S02_Problem: React.FC = () => {
  ...
  // Typewriter headline
  const headlineText = 'Her Gün Kaçırılan Çağrılar...';
