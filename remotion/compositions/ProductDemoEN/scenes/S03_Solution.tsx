/**
 * S03 Solution — Hero Tagline (English)
 */
  ...
  return (
    <SceneContainer>
      ...
      <CenteredContent style={{ opacity: exitOpacity }}>
        <div style={{ opacity: headlineOpacity, transform: `translateY(${headlineSlide}px)`, marginBottom: 50 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 50, opacity: phoneProgress, transform: `scale(${phoneProgress})` }}>
        ...
        <div style={{ display: 'flex', gap: 24, justifyContent: 'center' }}>
          {STAT_BADGES.map((badge, i) => {
            ...
            return (
              <div key={i} style={{ opacity: badgeProgress, transform: `translateY(${(1 - badgeProgress) * 30}px)` }}>
