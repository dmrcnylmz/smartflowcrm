/**
 * S06 Stats — Counter Animations (English)
 */
          ...
          {STATS_EN.map((stat, i) => {
            ...
            return (
              <GlassCard
                key={i}
                style={{
                  textAlign: 'center', padding: '48px 40px', opacity: cardProgress,
              ...
              >
                ...
                <div style={{ fontSize: 20, color: COLORS.textSecondary, fontWeight: 500 }}>
                  {stat.label}
                </div>
              </GlassCard>
            );
