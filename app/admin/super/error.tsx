...
const PAGE_TITLES: Record<ErrorLocale, string> = {
    tr: 'Süper yönetici paneli yüklenemedi',
    en: 'Failed to load super admin panel',
    de: 'Super-Admin-Panel konnte nicht geladen werden',
    fr: "Impossible de charger le panneau super administrateur",
};
