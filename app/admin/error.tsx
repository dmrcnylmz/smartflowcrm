...
const PAGE_TITLES: Record<ErrorLocale, string> = {
    tr: 'Yönetici paneli yüklenemedi',
    en: 'Failed to load admin panel',
    de: 'Admin-Panel konnte nicht geladen werden',
    fr: "Impossible de charger le panneau d'administration",
};
