...
const PAGE_TITLES: Record<ErrorLocale, string> = {
    tr: 'Kurulum sayfası yüklenemedi',
    en: 'Failed to load setup page',
    de: 'Einrichtungsseite konnte nicht geladen werden',
    fr: "Impossible de charger la page de configuration",
};
