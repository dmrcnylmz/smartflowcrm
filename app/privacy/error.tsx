...
const PAGE_TITLES: Record<ErrorLocale, string> = {
    tr: 'Gizlilik sayfası yüklenemedi',
    en: 'Failed to load privacy page',
    de: 'Datenschutzseite konnte nicht geladen werden',
    fr: 'Impossible de charger la page de confidentialité',
};
