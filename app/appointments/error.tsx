...
const PAGE_TITLES: Record<ErrorLocale, string> = {
    tr: 'Randevu verileri yüklenemedi',
    en: 'Failed to load appointment data',
    de: 'Termindaten konnten nicht geladen werden',
    fr: 'Impossible de charger les données de rendez-vous',
};
