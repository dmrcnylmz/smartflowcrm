...
const PAGE_TITLES: Record<ErrorLocale, string> = {
    tr: 'Şikayet verileri yüklenemedi',
    en: 'Failed to load complaint data',
    de: 'Beschwerdedaten konnten nicht geladen werden',
    fr: 'Impossible de charger les données des réclamations',
};
