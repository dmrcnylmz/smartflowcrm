...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'friendly', temperature: 0.8, maxTokens: 512, language: 'tr', voiceCatalogId: 'g-tr-chirp3hd-kore', ttsProvider: 'google' },
        fallbackRules: [
...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'professional', temperature: 0.7, maxTokens: 512, language: 'tr', voiceCatalogId: 'g-tr-chirp3hd-charon', ttsProvider: 'google' },
        fallbackRules: [
...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'professional', temperature: 0.6, maxTokens: 512, language: 'tr', voiceCatalogId: 'g-tr-chirp3hd-fenrir', ttsProvider: 'google' },
        fallbackRules: [
...
E-posta: {email}`,
        ...
        voiceConfig: { style: 'formal', temperature: 0.5, maxTokens: 512, language: 'tr', voiceCatalogId: 'g-tr-chirp3hd-leda', ttsProvider: 'google' },
        fallbackRules: [
