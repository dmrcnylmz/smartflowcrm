...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'empathetic', temperature: 0.6, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
E-posta: {email}`,
        ...
        voiceConfig: { style: 'friendly', temperature: 0.7, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
Hasar İhbar Hattı: {damage_hotline}`,
        ...
        voiceConfig: { style: 'professional', temperature: 0.5, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'empathetic', temperature: 0.7, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'friendly', temperature: 0.6, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'friendly', temperature: 0.8, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'professional', temperature: 0.7, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
Telefon: {phone}`,
        ...
        voiceConfig: { style: 'professional', temperature: 0.6, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
...
E-posta: {email}`,
        ...
        voiceConfig: { style: 'formal', temperature: 0.5, maxTokens: 512, language: 'tr', voiceCatalogId: 'ct-katie', ttsProvider: 'cartesia' },
        fallbackRules: [
